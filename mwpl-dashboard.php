		...
		<form enctype="multipart/form-data" method="post" action="options.php">
			<?php settings_fields( 'mwpl-settings-group3' ); ?>
				...
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row"></th>
						<td><label><i><?php _e('Your Goolge Analytics script can be found <a href=\'https://analytics.google.com/analytics/web/\'>here</a>.');?></i></label></td>
					</tr>
					<tr>
		...
		<div class="mwpl_bg_container">
			...
			<p class="mwpl_bg_container_footer">
				<table>
					...
					<td>
						<label class="mwpl_bg_container_label">
						  <span class='delete'><a class='submitdelete' onclick='return showNotice.warn();' href='<?php echo site_url().'/wp-admin/admin.php?page=memphis-custom-login.php&amp;_wpnonce='; ?><?php echo $nonce ?>&amp;action=delete&amp;file=<?php echo $imagename; ?>'>Delete Permanently</a></span>
						   <br/>
