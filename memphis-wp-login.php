...
Copyright 2019 Ian Howatson  (email : ian@howatson.net)
...
function mwpl_password_protected() {
	...
	if (!is_user_logged_in() && $_SERVER['REQUEST_URI'] != "/") {
		...
		wp_safe_redirect(site_url().'/wp-login.php?redirect_to='.urlencode($_SERVER['REQUEST_URI']));
...
////////////////////////////////////////
add_action('login_head', 'mwpl_document_ready_wp');
function mwpl_document_ready_wp() {
?>
<script>
